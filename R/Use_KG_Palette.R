...
#'
#' \code{get_KG_color} This function creates a vector of \code{n} color palette data for the KaradaColor Package.
...
#'
#' {scale_color_KG} Use KaradaColor color palette on ggplot2 colors.
...
#'
#' \code{scale_fill_KG} Use KaradaColor color palette on ggplot2 fills.
